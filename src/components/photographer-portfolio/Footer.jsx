...
export default function Footer() {
    return (
        <section className="relative overflow-hidden text-[#f4f4f2] py-8">
            <div className="container relative z-10 mx-auto px-4">
                <div className="-m-8 flex flex-wrap items-center justify-between">
                    ...
                    <div className="w-auto p-8">
                        <ul className="-m-5 flex flex-wrap  items-center text-gray-200 hover:text-gray-300">
                            <li className="p-5 w-full md:w-auto">
                                <a
